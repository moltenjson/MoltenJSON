...
/**
 * Thrown when a {@link net.reflxction.simplejson.configuration.tree.TreeConfiguration} attempts
 * to load or save a file which cannot be parsed by {@link com.google.gson.Gson}, or when
 * the specified {@link net.reflxction.simplejson.configuration.tree.strategy.TreeNamingStrategy} throws
 * an exception when trying to invoke {@code fromName}.
 * <p>
 * If {@link net.reflxction.simplejson.configuration.tree.TreeConfigurationBuilder#ignoreInvalidFiles(boolean)} is set to {@code true},
